        ...
        >
          <ul className="flex flex-col items-center p-4 mt-4 text-white rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-lg md:font-medium md:border-0 md:bg-slate-700 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            {user ? (
              <>
                <li>
                  <button className="block py-2 pr-4 pl-3 text-white rounded-md hover:bg-gray-100 md:hover:bg-transparent md:border-2 md:hover:text-gray-900 md:hover:bg-white md:p-3 dark:text-gray-400 md:dark:hover:text-white dark:hover:text-white  md:dark:hover:bg-transparent">
                    Sign Out
                  </button>
                </li>
              </>
